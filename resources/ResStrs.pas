...
const
  resProductName      = 'Filename To Lowercase Replacer';
resourcestring
...
const
  resProductName      = 'Reemplazador a Minusculas de Nombre de Fichero';
resourcestring
  resTfrMain_Caption  = resProductName;
...
{$IFDEF LanguageLatam}
const
  resProductName      = 'Reemplazador a Minusculas de Nombre de Archivo';
resourcestring
  resTfrMain_Caption  = resProductName;
  resTfrmAbout_Caption  = 'Acerca de ' + resProductName;
  resTfrmHelp_Caption   =
...
const
  resProductName      = 'Reemplazateur a Minusculas pour Nom d*Archives';
resourcestring
  resTfrMain_Caption  = resProductName;
